...
public interface IInstallationRepository
{
    ...
    /// </summary>
    Task<GodotInstallation?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<GodotInstallation?> GetDefaultAsync(CancellationToken cancellationToken = default);

    /// <summary>Persists a new installation record.</summary>
    Task AddAsync(GodotInstallation installation, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task UpdateAsync(GodotInstallation installation, CancellationToken cancellationToken = default);
